...
<video controls style={{ width: "100%", margin: "2rem 0" }}>
  <source src={`${import.meta.env.BASE_URL}/videos/AutoRegressionExample.mp4`} type="video/mp4" />
...
<video controls style={{ width: "100%", margin: "2rem 0" }}>
  <source src={`${import.meta.env.BASE_URL}/videos/TokenProbabilityDistributionExample.mp4`} type="video/mp4" />
  Your browser does not support the video tag.
</video>
...
<video controls style={{ width: "100%", margin: "2rem 0" }}>
  <source src={`${import.meta.env.BASE_URL}/videos/TokensNotWords.mp4`} type="video/mp4" />
  Your browser does not support the video tag.
</video>
...
First, the response generated by greedily sampling the most likely token at each step:
